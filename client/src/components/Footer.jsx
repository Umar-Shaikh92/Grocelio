...
const Footer = () => {
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24">
            {/* <hr className="border-b border-gray-500/30"/> */}
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-t border-gray-500/30 text-gray-500">
                <div>
                    ...
                    <p className="max-w-[410px] mt-6">We deliver fresh groceries & snacks straight to your door. Trusted by thousands, we aim to make your shopping experinece simple and affordable.</p>
                </div>
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-500">
                Copyright {new Date().getFullYear()} © Grocelio All Rights Reserved.
            </p>
        </div>
    );
};
